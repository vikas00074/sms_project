	...
	<body>
		...
		<div id="right_side"><br>
			<div id="demo">
				...
				<center>
				<form action="" method="post">
					&nbsp;&nbsp;<b>Enter Roll No:</b>&nbsp;&nbsp; <input type="text" name="roll_no" required>
					<input type="submit" name="search_by_roll_no_for_search" value="Search">
				</form><br><br>
				<h4><b><u>Student's details</u></b></h4>
				</center>
				<?php
				}
				...
				{
				?>
				<h4><b><u style="padding-left: 30px;">Student's details</u></b></h4><br>
				<table>
					<tr>
						<td>
							<b>Roll No:</b>
				...
				<table>
					<tr>
						<td id="td" style="padding-left: 30px;"><b>ID</b></td>
						<td id="td" style="padding-left: 30px;"><b>Name</b></td>
						<td id="td" style="padding-left: 30px;"><b>Mobile</b></td>
						<td id="td" style="padding-left: 30px;"><b>Courses</b></td>
						<td id="td" style="padding-left: 30px;"><b>View Detail</b></td>
					</tr>
				</table>
				</center>
				<?php
				...
				<table style="border-collapse: collapse;border: 1px solid black;">
					<tr>
						<td id="td" style="padding-left: 30px;"><?php echo $row['t_id']?></td>
						<td id="td" style="padding-left: 30px;"><?php echo $row['name']?></td>
						<td id="td" style="padding-left: 30px;"><?php echo $row['mobile']?></td>
						<td id="td" style="padding-left: 30px;"><?php echo $row['courses']?></td>
						<td id="td" style="padding-left: 30px;"><a href="#">View</a></td>
					</tr>
				</table>
				</center>
				<?php
